...
import json.HexCell;
import json.HexSection;
import model.NlpRegFile;
                  ...
                  /*  for (int i = 0; i < regFiles.size(); i++) {
                    ...
                    for (Integer index:integers){
                        ...
                        for (int i = 0; i < body.size(); i++) {
                            ...
                            String xx = getTableHeadByTableOcrResult(hexSection, "xx");
        ...
        try {
            ...
            for (Integer rowNo : rowCount) {
                ...
                for (int i = 0; i < rowCellList.size(); i++) {
                    ...
                    itemstring=itemstring.replace(",","");
                    if (StringUtils.isNotEmpty(itemstring)&&itemstring.matches(tableHeadRegix)) {
                        matchRowNo=rowNo;
                    }
