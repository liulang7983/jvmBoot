...
public class ThreadFactoryDemo2 {
    public static ThreadPoolExecutor poolExecutor=new ThreadPoolExecutor(4,4,1000, TimeUnit.MILLISECONDS,new LinkedBlockingDeque<>(),new CustomThreadFactory("ThreadFactoryDemo"));
